...
if __name__ == "__main__":
    if "snakemake" not in globals():
        ...
        snakemake.input = {
            "original_costs": "../resources/no_scenario/costs_2030.csv",  # Reference costs used for ratios between technologies witout values from REMIND-EU
            "region_mapping": "../config/regionmapping_21_EU11.csv",
            "remind_data": "../resources/no_scenario/i1/REMIND2PyPSAEUR.gdx",
        }

        snakemake.output = {
            "costs": "../resources/no_scenario/i1/y2030/costs.csv",
        }
